...
void* x11512 = apply_prim_sqrt(lst11514);
...
void* x11524 = apply_prim_random(lst11526);
...
//Dummy comment
//not do dummy comment
void* kont8445 = (decode_clo(env8579))[2];
//not do dummy comment
void* random = (decode_clo(env8579))[1];
void* cps_u45lst8446 = prim_cons(kont8445, a8378);

//clo-apply
arg_buffer[1]=reinterpret_cast<void*>(random);
arg_buffer[2] = cps_u45lst8446;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(random))[0]);
// call next proc using a function pointer
function_ptr();
return nullptr;
}
