...
//Dummy comment
mpf_t* mpfvar8945 = (mpf_t *)(GC_MALLOC(sizeof(mpf_t)));
mpf_init_set_str(*mpfvar8945, "3.5", 10);
void* a8412 = encode_mpf(mpfvar8945);

//clo-app
arg_buffer[2]=apply_prim_exact_u45round_1(a8412);
