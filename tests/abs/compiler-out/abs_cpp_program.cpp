...
void* x11494 = apply_prim_abs(lst11496);
...
void* x11522 = apply_prim_random(lst11524);
...
//Dummy comment
//not do dummy comment
void* abs = (decode_clo(env8578))[2];
//not do dummy comment
void* kont8444 = (decode_clo(env8578))[1];
void* cps_u45lst8445 = prim_cons(kont8444, a8377);

//clo-apply
arg_buffer[1]=reinterpret_cast<void*>(abs);
arg_buffer[2] = cps_u45lst8445;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(abs))[0]);
// call next proc using a function pointer
function_ptr();
return nullptr;
}
...
mpf_init_set_str(*mpfvar11663, "-99.523", 10);
