...
void list_u45ref_spec(void *_8916, void *kont8872, void *lst,
                      void *n); // list-ref
...
void member_u63_spec(void *_8920, void *kont8875, void *x,
                     void *lst); // member?
...
void foldl_spec(void *_8937, void *kont8885, void *fun, void *acc,
                void *lst); // foldl
...
void foldr_spec(void *_8940, void *kont8887, void *fun, void *acc,
                void *lst); // foldr
void *foldr = encode_clo(alloc_clo(foldr_fptr, 0));

void reverse_u45helper_fptr(); // reverse-helper
void reverse_u45helper_spec(void *_8941, void *kont8889, void *lst,
...
void take_u45helper_spec(void *_8955, void *kont8897, void *lst, void *n,
...
void ok_u63_fptr(); // ok?
void ok_u63_spec(void *_8961, void *kont8900, void *row, void *dist,
                 void *placed); // ok?
...
void q_u45helper_spec(void *_8972, void *kont8903, void *stack,
                      void *count); // q-helper
...
inline void even_u63_fptr() // even? -> generic version
{
  ...
  // clo-app
  arg_buffer[2] =
      apply_prim_equal_u63_2(int9002, apply_prim_modulo_2(x, int8981));
...
inline void odd_u63_fptr() // odd? -> generic version
{
  ...
  // clo-app
  arg_buffer[2] =
      apply_prim_equal_u63_2(int9001, apply_prim_modulo_2(x, int8981));
...
inline void list_u45ref_fptr() // list-ref -> generic version
{
  ...
  if (is_true(apply_prim__u61_2(int9002, n))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8872)[1])(
        kont8872, apply_prim_car_1(lst));
  } else {

    // clo-app
    list_u45ref_spec(list_u45ref, kont8872, apply_prim_cdr_1(lst),
                     apply_prim__u45_2(n, int9001));
  }
}

inline void list_u45ref_spec(void *_8916, void *kont8872, void *lst,
                             void *n) // list-ref
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void lam8917_fptr() // lam8917 -> generic version
{
  ...
  if (is_true(id_8743)) {
    ...
    reinterpret_cast<void (*)(void *, void *)>(
        decode_clo(decode_clo_array[3])[1])(decode_clo_array[3], bool_f8995);
  } else {

    // if-clause
    if (is_true(apply_prim_equal_u63_2(
            decode_clo_array[2], apply_prim_car_1(decode_clo_array[4])))) {
      // kont-clo-app case
      reinterpret_cast<void (*)(void *, void *)>(decode_clo(
          decode_clo_array[3])[1])(decode_clo_array[3], decode_clo_array[4]);
    } else {

      // clo-app
      member_spec(member, decode_clo_array[3], decode_clo_array[2],
...
inline void member_fptr() // member -> generic version
{
  ...
  void **clo9168 =
      alloc_kont(lam8917_fptr, reinterpret_cast<void *>(lam8917_spec), 3);
  ...
  if (is_true(apply_prim_null_u63_1(item))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(f_lam_8874)[1])(
        f_lam_8874, apply_prim_null_u63_1(item));
  } else {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(f_lam_8874)[1])(
        f_lam_8874, apply_prim_null_u63_1(lst));
  }
}

inline void member_spec(void *_8919, void *kont8873, void *item,
                        void *lst) // member
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void member_u63_spec(void *_8920, void *kont8875, void *x,
                            void *lst) // member?
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void length_fptr() // length -> generic version
{
  ...
  if (is_true(apply_prim_null_u63_1(lst))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8876)[1])(
        kont8876, int9002);
  } else {

    // creating new make-kont closure
    void **clo9170 =
        alloc_kont(lam8921_fptr, reinterpret_cast<void *>(lam8921_spec), 2);
...
inline void lam8926_fptr() // lam8926 -> generic version
{
  ...
  // creating new make-kont closure
  void **clo9172 =
      alloc_kont(lam8924_fptr, reinterpret_cast<void *>(lam8924_spec), 2);
  ...
  // clo-app
  map_spec(map, f_lam_8879, decode_clo_array[2],
           apply_prim_cdr_1(decode_clo_array[4]));
}
...
inline void map_fptr() // map -> generic version
{
  ...
  if (is_true(apply_prim_null_u63_1(lst))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8878)[1])(
        kont8878, apply_prim_list_0());
  } else {

    // creating new make-kont closure
    void **clo9174 =
        alloc_kont(lam8926_fptr, reinterpret_cast<void *>(lam8926_spec), 3);
...
inline void lam8931_fptr() // lam8931 -> generic version
{
  ...
  if (is_true(id_8768)) {
    ...
    // creating new make-kont closure
    void **clo9176 =
        alloc_kont(lam8929_fptr, reinterpret_cast<void *>(lam8929_spec), 2);
    ...
    // clo-app
    filter_spec(filter, f_lam_8882, decode_clo_array[3],
                apply_prim_cdr_1(decode_clo_array[4]));
  } else {
...
inline void filter_fptr() // filter -> generic version
{
  ...
  if (is_true(apply_prim_null_u63_1(lst))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8881)[1])(
        kont8881, apply_prim_list_0());
  } else {

    // creating new make-kont closure
    void **clo9178 =
        alloc_kont(lam8931_fptr, reinterpret_cast<void *>(lam8931_spec), 3);
...
inline void filter_spec(void *_8933, void *kont8881, void *op,
                        void *lst) // filter
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void drop_fptr() // drop -> generic version
{
  ...
  if (is_true(apply_prim__u61_2(n, int9002))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8884)[1])(
        kont8884, lst);
  } else {

    // clo-app
    drop_spec(drop, kont8884, apply_prim_cdr_1(lst),
              apply_prim__u45_2(n, int9001));
  }
}
...
inline void lam8935_fptr() // lam8935 -> generic version
{
  ...
  // clo-app
  foldl_spec(foldl, decode_clo_array[4], decode_clo_array[2], id_8780,
...
inline void foldl_fptr() // foldl -> generic version
{
  ...
  if (is_true(apply_prim_null_u63_1(lst))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8885)[1])(
        kont8885, acc);
  } else {

    // creating new make-kont closure
    void **clo9180 =
        alloc_kont(lam8935_fptr, reinterpret_cast<void *>(lam8935_spec), 3);
...
inline void foldl_spec(void *_8937, void *kont8885, void *fun, void *acc,
                       void *lst) // foldl
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void foldr_fptr() // foldr -> generic version
{
  ...
  if (is_true(apply_prim_null_u63_1(lst))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8887)[1])(
        kont8887, acc);
  } else {

    // creating new make-kont closure
    void **clo9182 =
        alloc_kont(lam8938_fptr, reinterpret_cast<void *>(lam8938_spec), 3);
...
inline void foldr_spec(void *_8940, void *kont8887, void *fun, void *acc,
                       void *lst) // foldr
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void reverse_u45helper_fptr() // reverse-helper -> generic version
{
  ...
  if (is_true(apply_prim_null_u63_1(lst))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8889)[1])(
        kont8889, lst2);
  } else {

    // clo-app
    reverse_u45helper_spec(reverse_u45helper, kont8889, apply_prim_cdr_1(lst),
                           apply_prim_cons_2(apply_prim_car_1(lst), lst2));
  }
}

inline void reverse_u45helper_spec(void *_8941, void *kont8889, void *lst,
                                   void *lst2) // reverse-helper
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void append1_fptr() // append1 -> generic version
{
  ...
  if (is_true(apply_prim_null_u63_1(lhs))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8891)[1])(
        kont8891, rhs);
  } else {

    // creating new make-kont closure
    void **clo9184 =
        alloc_kont(lam8943_fptr, reinterpret_cast<void *>(lam8943_spec), 2);
...
inline void append1_spec(void *_8945, void *kont8891, void *lhs,
                         void *rhs) // append1
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void lam8948_fptr() // lam8948 -> generic version
{
  ...
  if (is_true(apply_prim__u61_2(decode_clo_array[5], id_8796))) {
    ...
    // creating new make-kont closure
    void **clo9186 =
        alloc_kont(lam8946_fptr, reinterpret_cast<void *>(lam8946_spec), 2);
    ...
    // clo-app
    append1_spec(append1, f_lam_8894, apply_prim_list_1(decode_clo_array[2]),
                 decode_clo_array[3]);
  }
}
...
inline void lam8950_fptr() // lam8950 -> generic version
{
  ...
  // creating new make-kont closure
  void **clo9188 =
      alloc_kont(lam8948_fptr, reinterpret_cast<void *>(lam8948_spec), 4);
...
void append_fptr() // append
{
  ...
  // creating new make-kont closure
  void **clo9190 =
      alloc_kont(lam8950_fptr, reinterpret_cast<void *>(lam8950_spec), 2);
  ...
  // kont-clo-app case
  reinterpret_cast<void (*)(void *, void *)>(decode_clo(f_lam_8896)[1])(
      f_lam_8896, apply_prim_cdr_1(apply_prim_cdr_1(vargs)));
}
...
inline void take_u45helper_fptr() // take-helper -> generic version
{
  ...
  if (is_true(apply_prim__u61_2(n, int9002))) {
    ...
    // creating new make-kont closure
    void **clo9191 =
        alloc_kont(lam8953_fptr, reinterpret_cast<void *>(lam8953_spec), 1);
    ...
    // clo-app
    take_u45helper_spec(take_u45helper, kont8897, apply_prim_cdr_1(lst),
                        apply_prim__u45_2(n, int9001),
                        apply_prim_cons_2(apply_prim_car_1(lst), lst2));
  }
}

inline void take_u45helper_spec(void *_8955, void *kont8897, void *lst, void *n,
                                void *lst2) // take-helper
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void lam8957_fptr() // lam8957 -> generic version
{
  ...
  if (is_true(id_8824)) {
    ...
    // clo-app
    ok_u63_spec(ok_u63, decode_clo_array[5], decode_clo_array[3],
                apply_prim__u43_2(decode_clo_array[4], int9001),
                apply_prim_cdr_1(decode_clo_array[2]));
  } else {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(
        decode_clo(decode_clo_array[5])[1])(decode_clo_array[5], bool_f8995);
  }
}
...
inline void lam8959_fptr() // lam8959 -> generic version
{
  ...
  if (is_true(id_8818)) {
    ...
    // creating new make-kont closure
    void **clo9193 =
        alloc_kont(lam8957_fptr, reinterpret_cast<void *>(lam8957_spec), 4);
    ...
    if (is_true(apply_prim__u61_2(
            ...
            apply_prim__u45_2(decode_clo_array[3], decode_clo_array[4])))) {
      // kont-clo-app case
      reinterpret_cast<void (*)(void *, void *)>(decode_clo(f_lam_8901)[1])(
          f_lam_8901, bool_f8995);
    } else {
      // kont-clo-app case
      reinterpret_cast<void (*)(void *, void *)>(decode_clo(f_lam_8901)[1])(
          f_lam_8901, bool_t8997);
    }
...
inline void ok_u63_fptr() // ok? -> generic version
{
  ...
  if (is_true(apply_prim_null_u63_1(placed))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8900)[1])(
        kont8900, bool_t8997);
  } else {

    // creating new make-kont closure
    void **clo9195 =
        alloc_kont(lam8959_fptr, reinterpret_cast<void *>(lam8959_spec), 4);
    ...
    if (is_true(apply_prim__u61_2(apply_prim_car_1(placed),
      ...
      // kont-clo-app case
      reinterpret_cast<void (*)(void *, void *)>(decode_clo(f_lam_8902)[1])(
          f_lam_8902, bool_f8995);
    } else {
      // kont-clo-app case
      reinterpret_cast<void (*)(void *, void *)>(decode_clo(f_lam_8902)[1])(
          f_lam_8902, bool_t8997);
    }
  }
}

inline void ok_u63_spec(void *_8961, void *kont8900, void *row, void *dist,
                        void *placed) // ok?
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void lam8962_fptr() // lam8962 -> generic version
{
  ...
  arg_buffer[2] = apply_prim_cons_2(
      apply_prim_list_3(id_8848, apply_prim_list_0(),
...
inline void lam8964_fptr() // lam8964 -> generic version
{
  ...
  // clo-app
  q_u45helper_spec(q_u45helper, decode_clo_array[4],
                   apply_prim_cons_2(decode_clo_array[2], id_8855),
                   decode_clo_array[3]);
}
...
inline void lam8966_fptr() // lam8966 -> generic version
{
  ...
  // creating new make-kont closure
  void **clo9197 =
      alloc_kont(lam8964_fptr, reinterpret_cast<void *>(lam8964_spec), 3);
  ...
  if (is_true(id_8846)) {
    ...
    // creating new make-kont closure
    void **clo9198 =
        alloc_kont(lam8962_fptr, reinterpret_cast<void *>(lam8962_spec), 4);
    ...
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(f_lam_8904)[1])(
        f_lam_8904, apply_prim_cdr_1(decode_clo_array[8]));
  }
}
...
inline void lam8968_fptr() // lam8968 -> generic version
{
  ...
  if (is_true(apply_prim_null_u63_1(decode_clo_array[2]))) {
    ...
    if (is_true(apply_prim_null_u63_1(decode_clo_array[3]))) {
      ...
      // clo-app
      q_u45helper_spec(q_u45helper, decode_clo_array[5],
    ...
    // creating new make-kont closure
    void **clo9201 =
        alloc_kont(lam8966_fptr, reinterpret_cast<void *>(lam8966_spec), 7);

    // setting env list
    clo9201[2] = decode_clo_array[2];
    clo9201[3] = decode_clo_array[3];
    clo9201[4] = z;
    clo9201[5] = apply_prim_list_3(
        apply_prim_cdr_1(decode_clo_array[2]),
        apply_prim_cons_2(apply_prim_car_1(decode_clo_array[2]),
                          decode_clo_array[3]),
        z);
    ...
    // clo-app
    ok_u63_spec(ok_u63, f_lam_8906, apply_prim_car_1(decode_clo_array[2]),
                int9001, z);
  }
}
...
inline void lam8970_fptr() // lam8970 -> generic version
{
  ...
  // creating new make-kont closure
  void **clo9203 =
      alloc_kont(lam8968_fptr, reinterpret_cast<void *>(lam8968_spec), 5);
  ...
  // clo-app
  arg_buffer[2] =
      apply_prim_car_1(apply_prim_cdr_1(apply_prim_cdr_1(decode_clo_array[5])));
  arg_buffer[1] = f_lam_8907;
  numArgs = int9005;
  lam8968_spec(f_lam_8907, apply_prim_car_1(apply_prim_cdr_1(
                               apply_prim_cdr_1(decode_clo_array[5]))));
}
...
inline void q_u45helper_fptr() // q-helper -> generic version
{
  ...
  if (is_true(apply_prim_null_u63_1(stack))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8903)[1])(
        kont8903, count);
  } else {

    // creating new make-kont closure
    void **clo9205 =
        alloc_kont(lam8970_fptr, reinterpret_cast<void *>(lam8970_spec), 5);
    ...
    numArgs = int9005;
    lam8970_spec(f_lam_8908,
                 apply_prim_car_1(apply_prim_cdr_1(apply_prim_car_1(stack))));
  }
}

inline void q_u45helper_spec(void *_8972, void *kont8903, void *stack,
                             void *count) // q-helper
{
  // decoding closure array
  void **decode_clo_array = nullptr;
...
inline void iota1_fptr() // iota1 -> generic version
{
  ...
  if (is_true(apply_prim__u61_2(n, int9002))) {
    // kont-clo-app case
    reinterpret_cast<void (*)(void *, void *)>(decode_clo(kont8909)[1])(
        kont8909, l);
  } else {

    // clo-app
    iota1_spec(iota1, kont8909, apply_prim__u45_2(n, int9001),
...
inline void lam8974_fptr() // lam8974 -> generic version
{
  ...
  q_u45helper_spec(q_u45helper, decode_clo_array[2],
                   apply_prim_list_1(apply_prim_list_3(
                       id_8863, apply_prim_list_0(), apply_prim_list_0())),
                   int9002);
}
...
inline void nqueens_fptr() // nqueens -> generic version
{
  ...
  // creating new make-kont closure
  void **clo9207 =
      alloc_kont(lam8974_fptr, reinterpret_cast<void *>(lam8974_spec), 1);
