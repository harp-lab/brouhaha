...
void even_u63_fptr(long numArgs, void* _8829, void* kont8796, void* x); // even?
void* even_u63 = encode_clo(alloc_clo(even_u63_fptr, 0));

void odd_u63_fptr(long numArgs, void* _8830, void* kont8797, void* x); // odd?
void* odd_u63 = encode_clo(alloc_clo(odd_u63_fptr, 0));

void list_u45ref_fptr(long numArgs, void* _8831, void* kont8798, void* lst, void* n); // list-ref
...
void member_fptr(long numArgs, void* _8834, void* kont8799, void* item, void* lst); // member
void* member = encode_clo(alloc_clo(member_fptr, 0));

void member_u63_fptr(long numArgs, void* _8835, void* kont8801, void* x, void* lst); // member?
void* member_u63 = encode_clo(alloc_clo(member_u63_fptr, 0));

void lam8836_fptr(); // lam8836
void* lam8836 = encode_clo(alloc_clo(lam8836_fptr, 0));

void length_fptr(long numArgs, void* _8838, void* kont8802, void* lst); // length
...
void map_fptr(long numArgs, void* _8843, void* kont8804, void* proc, void* lst); // map
...
void filter_fptr(long numArgs, void* _8848, void* kont8807, void* op, void* lst); // filter
void* filter = encode_clo(alloc_clo(filter_fptr, 0));

void drop_fptr(long numArgs, void* _8849, void* kont8810, void* lst, void* n); // drop
void* drop = encode_clo(alloc_clo(drop_fptr, 0));

void lam8850_fptr(); // lam8850
void* lam8850 = encode_clo(alloc_clo(lam8850_fptr, 0));

void foldl_fptr(long numArgs, void* _8852, void* kont8811, void* fun, void* acc, void* lst); // foldl
void* foldl = encode_clo(alloc_clo(foldl_fptr, 0));

void lam8853_fptr(); // lam8853
void* lam8853 = encode_clo(alloc_clo(lam8853_fptr, 0));

void foldr_fptr(long numArgs, void* _8855, void* kont8813, void* fun, void* acc, void* lst); // foldr
void* foldr = encode_clo(alloc_clo(foldr_fptr, 0));

void reverse_u45helper_fptr(long numArgs, void* _8856, void* kont8815, void* lst, void* lst2); // reverse-helper
void* reverse_u45helper = encode_clo(alloc_clo(reverse_u45helper_fptr, 0));

void reverse_fptr(long numArgs, void* _8857, void* kont8816, void* lst); // reverse
void* reverse = encode_clo(alloc_clo(reverse_fptr, 0));

void lam8858_fptr(); // lam8858
void* lam8858 = encode_clo(alloc_clo(lam8858_fptr, 0));

void append1_fptr(long numArgs, void* _8860, void* kont8817, void* lhs, void* rhs); // append1
...
void take_u45helper_fptr(long numArgs, void* _8868, void* kont8822, void* lst, void* n, void* lst2); // take-helper
void* take_u45helper = encode_clo(alloc_clo(take_u45helper_fptr, 0));

void take_fptr(long numArgs, void* _8869, void* kont8824, void* lst, void* n); // take
void* take = encode_clo(alloc_clo(take_fptr, 0));

void addd_fptr(long numArgs, void* _8870, void* kont8825, void* y, void* z); // addd
void* addd = encode_clo(alloc_clo(addd_fptr, 0));

void call_fptr(long numArgs, void* _8871, void* kont8826, void* x); // call
void* call = encode_clo(alloc_clo(call_fptr, 0));

void brouhaha_main_fptr(long numArgs, void* _8872, void* kont8827); // brouhaha_main
...
auto decoded_call = reinterpret_cast<void (*)(long, void*, void*, void*)>((decode_clo(call))[0]);
...
auto decoded_addd = reinterpret_cast<void (*)(long, void*, void*, void*, void*)>((decode_clo(addd))[0]);
...
void* const x8891 = apply_prim__u43(lst8893);
...
void* const x8891 = apply_prim__u43(arg_buffer);
arg_buffer[1] = kont8890;
arg_buffer[2] = x8891;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8890))[0]);
...
void* const x8895 = apply_prim__u45(lst8897);
...
void* const x8895 = apply_prim__u45(arg_buffer);
arg_buffer[1] = kont8894;
arg_buffer[2] = x8895;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8894))[0]);
...
void* const x8899 = apply_prim__u42(lst8901);
...
void* const x8899 = apply_prim__u42(arg_buffer);
arg_buffer[1] = kont8898;
arg_buffer[2] = x8899;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8898))[0]);
...
void* const x8903 = apply_prim__u47(lst8905);
...
void* const x8903 = apply_prim__u47(arg_buffer);
arg_buffer[1] = kont8902;
arg_buffer[2] = x8903;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8902))[0]);
...
void* const x8907 = apply_prim__u61(lst8909);
...
void* const x8907 = apply_prim__u61(arg_buffer);
arg_buffer[1] = kont8906;
arg_buffer[2] = x8907;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8906))[0]);
...
void* const x8911 = apply_prim__u62(lst8913);
...
void* const x8911 = apply_prim__u62(arg_buffer);
arg_buffer[1] = kont8910;
arg_buffer[2] = x8911;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8910))[0]);
...
void* const x8915 = apply_prim__u60(lst8917);
...
void* const x8915 = apply_prim__u60(arg_buffer);
arg_buffer[1] = kont8914;
arg_buffer[2] = x8915;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8914))[0]);
...
void* const x8919 = apply_prim__u60_u61(lst8921);
...
void* const x8919 = apply_prim__u60_u61(arg_buffer);
arg_buffer[1] = kont8918;
arg_buffer[2] = x8919;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8918))[0]);
...
void* const x8923 = apply_prim__u62_u61(lst8925);
...
void* const x8923 = apply_prim__u62_u61(arg_buffer);
arg_buffer[1] = kont8922;
arg_buffer[2] = x8923;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8922))[0]);
...
void* const x8927 = apply_prim_modulo(lst8929);
...
void* const x8927 = apply_prim_modulo(arg_buffer);
arg_buffer[1] = kont8926;
arg_buffer[2] = x8927;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8926))[0]);
...
void* const x8931 = apply_prim_null_u63(lst8933);
...
void* const x8931 = apply_prim_null_u63(arg_buffer);
arg_buffer[1] = kont8930;
arg_buffer[2] = x8931;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8930))[0]);
...
void* const x8935 = apply_prim_equal_u63(lst8937);
...
void* const x8935 = apply_prim_equal_u63(arg_buffer);
arg_buffer[1] = kont8934;
arg_buffer[2] = x8935;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8934))[0]);
...
void* const x8939 = apply_prim_eq_u63(lst8941);
...
void* const x8939 = apply_prim_eq_u63(arg_buffer);
arg_buffer[1] = kont8938;
arg_buffer[2] = x8939;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8938))[0]);
...
void* const x8943 = apply_prim_cons(lst8945);
...
void* const x8943 = apply_prim_cons(arg_buffer);
arg_buffer[1] = kont8942;
arg_buffer[2] = x8943;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8942))[0]);
...
void* const x8947 = apply_prim_car(lst8949);
...
void* const x8947 = apply_prim_car(arg_buffer);
arg_buffer[1] = kont8946;
arg_buffer[2] = x8947;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8946))[0]);
...
void* const x8951 = apply_prim_cdr(lst8953);
...
void* const x8951 = apply_prim_cdr(arg_buffer);
arg_buffer[1] = kont8950;
arg_buffer[2] = x8951;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8950))[0]);
...
void* const x8955 = apply_prim_float_u45_u62int(lst8957);
...
void* const x8955 = apply_prim_float_u45_u62int(arg_buffer);
arg_buffer[1] = kont8954;
arg_buffer[2] = x8955;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8954))[0]);
...
void* const x8959 = apply_prim_int_u45_u62float(lst8961);
...
void* const x8959 = apply_prim_int_u45_u62float(arg_buffer);
arg_buffer[1] = kont8958;
arg_buffer[2] = x8959;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8958))[0]);
...
void* const x8963 = apply_prim_hash(lst8965);
...
void* const x8963 = apply_prim_hash(arg_buffer);
arg_buffer[1] = kont8962;
arg_buffer[2] = x8963;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8962))[0]);
...
void* const x8967 = apply_prim_hash_u45ref(lst8969);
...
void* const x8967 = apply_prim_hash_u45ref(arg_buffer);
arg_buffer[1] = kont8966;
arg_buffer[2] = x8967;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8966))[0]);
...
void* const x8971 = apply_prim_hash_u45set(lst8973);
...
void* const x8971 = apply_prim_hash_u45set(arg_buffer);
arg_buffer[1] = kont8970;
arg_buffer[2] = x8971;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8970))[0]);
...
void* const x8975 = apply_prim_hash_u45keys(lst8977);
...
void* const x8979 = apply_prim_hash_u45has_u45key_u63(lst8981);
...
void* const x8979 = apply_prim_hash_u45has_u45key_u63(arg_buffer);
arg_buffer[1] = kont8978;
arg_buffer[2] = x8979;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8978))[0]);
...
void* const x8983 = apply_prim_hash_u45count(lst8985);
...
void* const x8983 = apply_prim_hash_u45count(arg_buffer);
arg_buffer[1] = kont8982;
arg_buffer[2] = x8983;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8982))[0]);
...
void* const x8987 = apply_prim_set(lst8989);
...
void* const x8987 = apply_prim_set(arg_buffer);
arg_buffer[1] = kont8986;
arg_buffer[2] = x8987;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8986))[0]);
...
void* const x8991 = apply_prim_set_u45_u62list(lst8993);
...
void* const x8991 = apply_prim_set_u45_u62list(arg_buffer);
arg_buffer[1] = kont8990;
arg_buffer[2] = x8991;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8990))[0]);
...
void* const x8995 = apply_prim_list_u45_u62set(lst8997);
...
void* const x8999 = apply_prim_set_u45add(lst9001);
...
void* const x8999 = apply_prim_set_u45add(arg_buffer);
arg_buffer[1] = kont8998;
arg_buffer[2] = x8999;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont8998))[0]);
...
void* const x9003 = apply_prim_set_u45member_u63(lst9005);
...
void* const x9007 = apply_prim_set_u45remove(lst9009);
...
void* const x9007 = apply_prim_set_u45remove(arg_buffer);
arg_buffer[1] = kont9006;
arg_buffer[2] = x9007;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9006))[0]);
...
void* const x9011 = apply_prim_set_u45count(lst9013);
...
void* const x9011 = apply_prim_set_u45count(arg_buffer);
arg_buffer[1] = kont9010;
arg_buffer[2] = x9011;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9010))[0]);
...
void* const x9015 = apply_prim_string_u63(lst9017);
...
void* const x9015 = apply_prim_string_u63(arg_buffer);
arg_buffer[1] = kont9014;
arg_buffer[2] = x9015;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9014))[0]);
...
void* const x9019 = apply_prim_string_u45length(lst9021);
...
void* const x9019 = apply_prim_string_u45length(arg_buffer);
arg_buffer[1] = kont9018;
arg_buffer[2] = x9019;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9018))[0]);
...
void* const x9023 = apply_prim_string_u45ref(lst9025);
...
void* const x9023 = apply_prim_string_u45ref(arg_buffer);
arg_buffer[1] = kont9022;
arg_buffer[2] = x9023;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9022))[0]);
...
void* const x9027 = apply_prim_substring(lst9029);
...
void* const x9027 = apply_prim_substring(arg_buffer);
arg_buffer[1] = kont9026;
arg_buffer[2] = x9027;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9026))[0]);
...
void* const x9031 = apply_prim_string_u45append(lst9033);
...
void* const x9031 = apply_prim_string_u45append(arg_buffer);
arg_buffer[1] = kont9030;
arg_buffer[2] = x9031;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9030))[0]);
...
void* const x9035 = apply_prim_string_u45_u62list(lst9037);
...
void* const x9035 = apply_prim_string_u45_u62list(arg_buffer);
arg_buffer[1] = kont9034;
arg_buffer[2] = x9035;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9034))[0]);
...
void* const x9039 = apply_prim_exact_u45floor(lst9041);
...
void* const x9039 = apply_prim_exact_u45floor(arg_buffer);
arg_buffer[1] = kont9038;
arg_buffer[2] = x9039;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9038))[0]);
...
void* const x9043 = apply_prim_exact_u45ceiling(lst9045);
...
void* const x9043 = apply_prim_exact_u45ceiling(arg_buffer);
arg_buffer[1] = kont9042;
arg_buffer[2] = x9043;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9042))[0]);
...
void* const x9047 = apply_prim_exact_u45round(lst9049);
...
void* const x9047 = apply_prim_exact_u45round(arg_buffer);
arg_buffer[1] = kont9046;
arg_buffer[2] = x9047;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9046))[0]);
...
void* const x9051 = apply_prim_abs(lst9053);
...
void* const x9051 = apply_prim_abs(arg_buffer);
arg_buffer[1] = kont9050;
arg_buffer[2] = x9051;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9050))[0]);
...
void* const x9055 = apply_prim_max(lst9057);
...
void* const x9055 = apply_prim_max(arg_buffer);
arg_buffer[1] = kont9054;
arg_buffer[2] = x9055;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9054))[0]);
...
void* const x9059 = apply_prim_min(lst9061);
...
void* const x9059 = apply_prim_min(arg_buffer);
arg_buffer[1] = kont9058;
arg_buffer[2] = x9059;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9058))[0]);
...
void* const x9063 = apply_prim_expt(lst9065);
...
void* const x9063 = apply_prim_expt(arg_buffer);
arg_buffer[1] = kont9062;
arg_buffer[2] = x9063;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9062))[0]);
...
void* const x9067 = apply_prim_sqrt(lst9069);
...
void* const x9067 = apply_prim_sqrt(arg_buffer);
arg_buffer[1] = kont9066;
arg_buffer[2] = x9067;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9066))[0]);
...
void* const x9071 = apply_prim_remainder(lst9073);
...
void* const x9071 = apply_prim_remainder(arg_buffer);
arg_buffer[1] = kont9070;
arg_buffer[2] = x9071;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9070))[0]);
...
void* const x9075 = apply_prim_quotient(lst9077);
...
void* const x9075 = apply_prim_quotient(arg_buffer);
arg_buffer[1] = kont9074;
arg_buffer[2] = x9075;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9074))[0]);
...
void* const x9079 = apply_prim_random(lst9081);
...
void* const x9079 = apply_prim_random(arg_buffer);
arg_buffer[1] = kont9078;
arg_buffer[2] = x9079;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9078))[0]);
...
void* const x9083 = apply_prim_symbol_u63(lst9085);
...
void* const x9083 = apply_prim_symbol_u63(arg_buffer);
arg_buffer[1] = kont9082;
arg_buffer[2] = x9083;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9082))[0]);
...
void* const x9087 = apply_prim_pair_u63(lst9089);
...
void* const x9087 = apply_prim_pair_u63(arg_buffer);
arg_buffer[1] = kont9086;
arg_buffer[2] = x9087;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9086))[0]);
...
void* const x9091 = apply_prim_positive_u63(lst9093);
...
void* const x9091 = apply_prim_positive_u63(arg_buffer);
arg_buffer[1] = kont9090;
arg_buffer[2] = x9091;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9090))[0]);
...
void* const x9095 = apply_prim_negative_u63(lst9097);
...
void* const x9095 = apply_prim_negative_u63(arg_buffer);
arg_buffer[1] = kont9094;
arg_buffer[2] = x9095;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9094))[0]);
...
void* const x9099 = apply_prim_list(lst9101);
...
void* const x9099 = apply_prim_list(arg_buffer);
arg_buffer[1] = kont9098;
arg_buffer[2] = x9099;
arg_buffer[0] = reinterpret_cast<void*>(2);
auto function_ptr = reinterpret_cast<void (*)()>((decode_clo(kont9098))[0]);
...
//decoding closure array
void** decode_clo_array = nullptr;
void* const id_8714 = int8886;
void* const id_8715 = int8876;
...
//decoding closure array
void** decode_clo_array = nullptr;
void* const id_8717 = int8889;
void* const id_8718 = int8876;
...
//decoding closure array
void** decode_clo_array = nullptr;
void* const id_8720 = int8886;
void* const id_8721 = apply_prim__u61_2(id_8720, n);

//if-clause
bool if_guard9102 = is_true(id_8721);
if(if_guard9102)
{
...
void* const id_8724 = int8889;
void* const id_8725 = apply_prim__u45_2(n, id_8724);

//clo-app
decoded_list_u45ref(4, list_u45ref, kont8798, id_8723, id_8725);
}
...
void lam8832_fptr() // lam8832 
{
std::cout<<"In lam8832_fptr"<<std::endl;
//reading number of args
numArgs = reinterpret_cast<long>(arg_buffer[0]);
//reading env
...
void* const kont8799 = decode_clo_array[1];

//if-clause
bool if_guard9103 = is_true(id_8729);
if(if_guard9103)
{
void* const xy8730 = bool_f8881;
...
//if-clause
bool if_guard9104 = is_true(id_8732);
if(if_guard9104)
{
...
//clo-app
decoded_member(4, member, kont8799, item, id_8733);
}
...
void** clo9105 = alloc_clo(lam8832_fptr, 3);

//setting env list
clo9105[1] = kont8799;
clo9105[2] = item;
clo9105[3] = lst;
void* f8800 = encode_clo(clo9105);



//if-clause
bool if_guard9106 = is_true(id_8726);
if(if_guard9106)
{
...
//if-clause
bool if_guard9107 = is_true(id_8734);
if(if_guard9107)
{
void* const xy8735 = bool_f8881;
...
//if-clause
bool if_guard9108 = is_true(id_8737);
if(if_guard9108)
{
void* const xy8738 = bool_t8880;
...
//clo-app
decoded_member_u63(4, member_u63, kont8801, x, id_8739);
}
...
//if-clause
bool if_guard9109 = is_true(id_8740);
if(if_guard9109)
{
void* const xy8741 = int8886;
...
{
void* const id_8742 = int8889;
void* const id_8743 = apply_prim_cdr_1(lst);

//creating new closure instance
void** clo9110 = alloc_clo(lam8836_fptr, 2);

//setting env list
clo9110[1] = kont8802;
clo9110[2] = id_8742;
void* f8803 = encode_clo(clo9110);



//clo-app
decoded_length(3, length, f8803, id_8743);
}
...
void lam8839_fptr() // lam8839 
{
std::cout<<"In lam8839_fptr"<<std::endl;
//reading number of args
numArgs = reinterpret_cast<long>(arg_buffer[0]);
//reading env
...
void lam8841_fptr() // lam8841 
{
std::cout<<"In lam8841_fptr"<<std::endl;
//reading number of args
numArgs = reinterpret_cast<long>(arg_buffer[0]);
//reading env
...
void* const kont8804 = decode_clo_array[3];
void* const lst = decode_clo_array[2];
void* const proc = decode_clo_array[1];
void* const id_8749 = apply_prim_cdr_1(lst);

//creating new closure instance
void** clo9111 = alloc_clo(lam8839_fptr, 2);

//setting env list
clo9111[1] = id_8748;
clo9111[2] = kont8804;
void* f8805 = encode_clo(clo9111);



//clo-app
decoded_map(4, map, f8805, proc, id_8749);
}
...
//if-clause
bool if_guard9112 = is_true(id_8745);
if(if_guard9112)
{
...
//creating new closure instance
void** clo9113 = alloc_clo(lam8841_fptr, 3);

//setting env list
clo9113[1] = proc;
clo9113[2] = lst;
clo9113[3] = kont8804;
void* f8806 = encode_clo(clo9113);
...
void lam8844_fptr() // lam8844 
{
std::cout<<"In lam8844_fptr"<<std::endl;
//reading number of args
numArgs = reinterpret_cast<long>(arg_buffer[0]);
//reading env
...
void lam8846_fptr() // lam8846 
{
std::cout<<"In lam8846_fptr"<<std::endl;
//reading number of args
numArgs = reinterpret_cast<long>(arg_buffer[0]);
//reading env
...
void* const op = decode_clo_array[3];
void* const lst = decode_clo_array[2];
void* const kont8807 = decode_clo_array[1];

//if-clause
bool if_guard9114 = is_true(id_8754);
if(if_guard9114)
{
...
//creating new closure instance
void** clo9115 = alloc_clo(lam8844_fptr, 2);

//setting env list
clo9115[1] = kont8807;
clo9115[2] = id_8755;
void* f8808 = encode_clo(clo9115);



//clo-app
decoded_filter(4, filter, f8808, op, id_8756);
}
else
{
...
//clo-app
decoded_filter(4, filter, kont8807, op, id_8758);
}
...
//if-clause
bool if_guard9116 = is_true(id_8751);
if(if_guard9116)
{
...
//creating new closure instance
void** clo9117 = alloc_clo(lam8846_fptr, 3);

//setting env list
clo9117[1] = kont8807;
clo9117[2] = lst;
clo9117[3] = op;
void* f8809 = encode_clo(clo9117);
...
//decoding closure array
void** decode_clo_array = nullptr;
void* const id_8759 = int8886;
void* const id_8760 = apply_prim__u61_2(n, id_8759);

//if-clause
bool if_guard9118 = is_true(id_8760);
if(if_guard9118)
{
...
void* const id_8762 = int8889;
void* const id_8763 = apply_prim__u45_2(n, id_8762);

//clo-app
decoded_drop(4, drop, kont8810, id_8761, id_8763);
}
...
void* const lst = decode_clo_array[3];
void* const kont8811 = decode_clo_array[2];
void* const fun = decode_clo_array[1];
void* const id_8767 = apply_prim_cdr_1(lst);

//clo-app
decoded_foldl(5, foldl, kont8811, fun, id_8766, id_8767);
}
...
//if-clause
bool if_guard9119 = is_true(id_8764);
if(if_guard9119)
{
...
//creating new closure instance
void** clo9120 = alloc_clo(lam8850_fptr, 3);

//setting env list
clo9120[1] = fun;
clo9120[2] = kont8811;
clo9120[3] = lst;
void* f8812 = encode_clo(clo9120);
...
void lam8853_fptr() // lam8853 
{
std::cout<<"In lam8853_fptr"<<std::endl;
//reading number of args
numArgs = reinterpret_cast<long>(arg_buffer[0]);
//reading env
...
clo9122[2] = fun;
clo9122[3] = id_8769;
void* f8814 = encode_clo(clo9122);



//clo-app
decoded_foldr(5, foldr, f8814, fun, acc, id_8770);
}
...
//clo-app
decoded_reverse_u45helper(4, reverse_u45helper, kont8815, id_8773, id_8775);
}
...
//clo-app
decoded_reverse_u45helper(4, reverse_u45helper, kont8816, lst, id_8776);
}

void lam8858_fptr() // lam8858 
{
std::cout<<"In lam8858_fptr"<<std::endl;
//reading number of args
numArgs = reinterpret_cast<long>(arg_buffer[0]);
//reading env
...
//if-clause
bool if_guard9124 = is_true(id_8777);
if(if_guard9124)
{
...
//creating new closure instance
void** clo9125 = alloc_clo(lam8858_fptr, 2);

//setting env list
clo9125[1] = kont8817;
clo9125[2] = id_8778;
void* f8818 = encode_clo(clo9125);



//clo-app
decoded_append1(4, append1, f8818, id_8779, rhs);
}
...
//clo-app
decoded_foldr(5, foldr, kont8819, append1, id_8781, id_8783);
}

void lam8863_fptr() // lam8863 
{
std::cout<<"In lam8863_fptr"<<std::endl;
//reading number of args
numArgs = reinterpret_cast<long>(arg_buffer[0]);
//reading env
...
//creating new closure instance
void** clo9126 = alloc_clo(lam8861_fptr, 2);

//setting env list
clo9126[1] = id_8781;
clo9126[2] = kont8819;
void* f8820 = encode_clo(clo9126);



//clo-app
decoded_append1(4, append1, f8820, id_8782, x);
}
...
void* const kont8819 = apply_prim_car_1(vargs);
void* const vargs8828 = apply_prim_cdr_1(vargs);
void* const xs = apply_prim_car_1(vargs8828);
void* const vargs8713 = apply_prim_cdr_1(vargs8828);

//creating new closure instance
void** clo9127 = alloc_clo(lam8863_fptr, 2);
...
void lam8866_fptr() // lam8866 
{
std::cout<<"In lam8866_fptr"<<std::endl;
//reading number of args
numArgs = reinterpret_cast<long>(arg_buffer[0]);
//reading env
...
//decoding closure array
void** decode_clo_array = nullptr;
void* const id_8784 = int8886;
void* const id_8785 = apply_prim__u61_2(n, id_8784);

//if-clause
bool if_guard9128 = is_true(id_8785);
if(if_guard9128)
{

//creating new closure instance
void** clo9129 = alloc_clo(lam8866_fptr, 1);

//setting env list
clo9129[1] = kont8822;
void* f8823 = encode_clo(clo9129);



//clo-app
decoded_reverse(3, reverse, f8823, lst2);
}
else
{
void* const id_8787 = apply_prim_cdr_1(lst);
void* const id_8788 = int8889;
...
//clo-app
decoded_take_u45helper(5, take_u45helper, kont8822, id_8787, id_8789, id_8791);
}
...
//clo-app
decoded_take_u45helper(5, take_u45helper, kont8824, lst, n, id_8792);
}
...
//decoding closure array
void** decode_clo_array = nullptr;
void* const xy8793 = apply_prim__u43_2(y, z);
...
//decoding closure array
void** decode_clo_array = nullptr;
void* const id_8794 = int8888;

//clo-app
decoded_addd(4, addd, kont8826, x, id_8794);
}
...
//decoding closure array
void** decode_clo_array = nullptr;
void* const id_8795 = int8889;

//clo-app
decoded_call(3, call, kont8827, id_8795);
}
...
int8886 = reinterpret_cast<void*>(encode_int(0));
bool_t8880 = encode_bool(true);
int8889 = reinterpret_cast<void*>(encode_int(1));
bool_f8881 = encode_bool(false);
int8876 = reinterpret_cast<void*>(encode_int(2));
int8888 = reinterpret_cast<void*>(encode_int(19));
